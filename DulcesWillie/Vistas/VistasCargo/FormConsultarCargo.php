...
<html>
    <head>
        ...
        <body>
        <center>
            <table class="table table-responsive" id="tabla" border="0" >
            <tr>
            <div name="FormConsultarCargo">
                <td>
            ...
            <tr>
                <td>
                    <center><input type="submit" name="Consultar" value="Consultar Cargo" class="form-control" placeholder="Guardar Cargo" title="Guardar Cargo"></center>
                </td> 
            </tr>
            <tr>
