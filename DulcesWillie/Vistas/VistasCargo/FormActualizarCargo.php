...
<html>
    <head>
        ...
        <center>
            ...
            <tr>
                <td>
                    <center><input type="submit" name="Actualizar" value="Actualizar Cargo" class="form-control" placeholder="Guardar Cargo" title="Guardar Cargo"></center>
                </td> 
            </tr>
            <tr>
