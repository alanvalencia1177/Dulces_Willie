...
<body>
  <center>
    ...
    <table id="tabla" border="1">
      <tr>
        <th colspan="5">
          <center><label> Menu principal</label></center>
        </th>
      </tr>
      <tr>
        <td>
            ...
            <ul>
              ...
              <li><a href="#">Empleado</a>
                <ul>
                  ...
                  <li><a href="Controlador.php?ruta=mostrarInsertarEmpleado">Gestor empleado</a></li>
                  <li><a href="Controlador.php?ruta=listarEmpleado">Listado de los empleados </a></li>

                </ul>
              </li>
              <li><a href="#">Cliente</a>
                <ul>
                  <li><a href="Controlador.php?ruta=mostrarInsertarCliente">Insertar Cliente</a></li>
                  <li><a href="Controlador.php?ruta=listarCliente">Mostar todos los Clientes</a></li>
